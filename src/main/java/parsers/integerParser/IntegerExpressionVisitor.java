 ...
 */
public class IntegerExpressionVisitor extends IntegerExprBaseVisitor<Expression> {
     ...
     */
    public IntegerExpressionVisitor(MathContext mc){
        mathContext = mc;
    }
     ...
     */
    @Override
    public Expression visitInput(IntegerExprParser.InputContext ctx) {
     ...
     */
    @Override
    public Expression visitExpr(IntegerExprParser.ExprContext ctx) {
        return visit(ctx.getChild(0));
    }
     ...
     */
    @Override
    public Expression visitPrefixOperation(IntegerExprParser.PrefixOperationContext ctx) {
        stack.addNewArray();
     ...
     */
    @Override
    public Expression visitPostfixOperation(IntegerExprParser.PostfixOperationContext ctx) {
        stack.addNewArray();
     ...
     */
    @Override
    public Expression visitValues(IntegerExprParser.ValuesContext ctx) {
     ...
     */
    @Override
    public Expression visitPlus(IntegerExprParser.PlusContext ctx){
        try {
     ...
     */
    @Override
    public Expression visitMinus(IntegerExprParser.MinusContext ctx) {
        try {
     ...
     */
    @Override
    public Expression visitTimes(IntegerExprParser.TimesContext ctx) {
        try {
     ...
     */
    @Override
    public Expression visitDivides(IntegerExprParser.DividesContext ctx) {
        try {
     ...
     */
    @Override
    public Expression visitModulo(IntegerExprParser.ModuloContext ctx) {
        try {
     ...
     */
    @Override
    public Expression visitPower(IntegerExprParser.PowerContext ctx) {
        try {
     ...
     */
    @Override
    public Expression visitGCD(IntegerExprParser.GCDContext ctx) {
        try {
     ...
     */
    @Override
    public Expression visitLCM(IntegerExprParser.LCMContext ctx) {
        try {
     ...
     */
    @Override
    public Expression visitInteger(IntegerExprParser.IntegerContext ctx) {
     ...
     */
    @Override
    public Expression visitInfixOperation(IntegerExprParser.InfixOperationContext ctx) {
        stack.addNewArray();
     ...
     */
    @Override
    public Expression visitStartValueInfix(IntegerExprParser.StartValueInfixContext ctx) {
        stack.addNewArray();
        Expression e = visit(ctx.getChild(0));
     ...
     */
    @Override
    public Expression visitInfixPlus(IntegerExprParser.InfixPlusContext ctx) {
        visit(ctx.getChild(1));
        try{
     ...
     */
    @Override
    public Expression visitInfixMinus(IntegerExprParser.InfixMinusContext ctx) {
        visit(ctx.getChild(1));
        try{
     ...
     */
    @Override
    public Expression visitSecondValueInfix(IntegerExprParser.SecondValueInfixContext ctx) {
        stack.addNewArray();
        Expression e = visit(ctx.getChild(0));
        Expression e2 = visit(ctx.getChild(1));
        stack.popArray();
     ...
     */
    @Override
    public Expression visitInfixTimes(IntegerExprParser.InfixTimesContext ctx) {
        visit(ctx.getChild(1));
        try{
     ...
     */
    @Override
    public Expression visitInfixDivides(IntegerExprParser.InfixDividesContext ctx) {
        visit(ctx.getChild(1));
        try{
     ...
     */
    @Override
    public Expression visitF(IntegerExprParser.FContext ctx) {
        Expression e = visit(ctx.getChild(0));
        if ( e == null){
