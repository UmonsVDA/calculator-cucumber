...
//	static final Logger log = getLogger(lookup().lookupClass());
    ...
    public void thenTheOperationIs(String s, int val) {
        try {
            ...
            TestUtils.checkOptionalContent(val, c.eval(op));
        } catch (IllegalOperationException e) {
            fail();
        }
    }
    ...
    public void thenTheResultOfOperation(String val) {
        TestUtils.checkOptionalContent(new BigDecimal(val), c.evalReal(op));
    }
    ...
    public void thenTheOperationEvaluatesTo(String val) {
        ...
        TestUtils.checkOptionalContent(MyRationalNumber.create(Integer.parseInt(parts[0]), Integer.parseInt(parts[1])), c.evalRational(op));
    }
